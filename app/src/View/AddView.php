...
<div class="container">
    ...
    <ul>
        ...
        <li><a href="/bikestores/add_category.php">Add Category</a></li>
        <li><a href="/bikestores/add_product.php">Add Product</a></li>
        <li><a href="/bikestores/add_stock.php">Add Stock</a></li>
    </ul>
    <h3>Modify</h3>
    <ul>
